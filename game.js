...
/* =============================================================================
   ...
   ============================================================================= */
(function(){
 window.LPW_DECISION_SCORE_AUDIT_VERSION='8.6.17';
 document.querySelectorAll('.build-tag').forEach(node=>node.textContent='VERSION 8.6.17');
})();
...
/* ============================================================
   LEGACY PRO WRESTLING 8.6.6 — BRAND IDENTITY INTEGRATION
   ============================================================ */
window.LPW_BRAND_VERSION='8.6.17';
